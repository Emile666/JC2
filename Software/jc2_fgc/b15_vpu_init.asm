...
; **** Main Initializaion Of The Floppy-/Graphics-Controller *******************
...
FGC_INIT        SEI
                ...
                STX     CARD0_INFO      ; set pointer to card info routine
                STY     CARD0_INFO+1
FGC_READ_DIP_SW LDA     FGC_START_CONF  ; release microcontroller data port for reading
                ...
                STA     PIA_PORTC
                LDA     PIA_PORTA       ; load dip switch settings
...
FGC_INFO_STR1   .by    ' Yamaha V9938 VPU Controller at $' $00
FGC_INFO_STR2   .by    ' Dual Floppy Controller at $' $00
...
B15_3		.local,	$05FB			; Emile: was $15FB in original source, but $3FFB in .bin file
